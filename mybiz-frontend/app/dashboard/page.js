    ...
    return (
        <div className="h-screen box-border">
            ...
            <div className="flex flex-row w-full h-screen justify-center">
                <SideNav />
                <main className='w-[80%] pr-[5%] pl-[5%] pt-[5%] flex flex-col md:flex-row md:flex-wrap gap-4'>
                    ...
                    <div className='cards flex flex-col justify-center'>
                        ...
                        <button className='border text-[#001F3F] rounded p-2 mt-4 hover:bg-[#F8FAFC]'>View summary<FontAwesomeIcon className='ml-2' icon={faArrowUpRightFromSquare} /></button>
                    </div>
                    <div className='cards flex flex-col justify-center'>
                        <h5 className='text-center text-[#001F3F]'>
                            ALL PRODUCTS
